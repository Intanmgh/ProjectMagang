...
<head>
    ...
    <style>
        ...
        .login-image-section {
            ...
            background-image: url('{{ asset('image/background_login.jpg') }}'); /* Ganti dengan path gambar Anda */
...
<body>
    <div class="login-page-container">
        ...
        <div class="login-form-section">
            <img src="{{ asset('image/logo tel.png') }}" alt="logo tel.png" class="logo"> <h1>Welcome!</h1>
